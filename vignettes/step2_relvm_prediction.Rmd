...
weight_tbl<- as.matrix(weight_tbl)
...
idx   = 1  
score_row = as.matrix(score_tbl[idx,])
weight_row= as.matrix(weight_tbl[idx,])
fv    = 0
theta <- list(mu=mu,   # 
              fl=fl,   #  
              err =err # 
...
fitall <- relvm:::pred(score_tbl=score_tbl, wts_tbl=weight_tbl,pms=theta)
```
